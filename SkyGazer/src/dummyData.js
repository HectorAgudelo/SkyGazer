const dummyArticles = [
  {
    author: "Kris Holt",
    content: `NASA Administrator Bill Nelson, U.S. Environmental Protection Agency (EPA) Administrator Michael Regan, and other United States government leaders unveiled the U.S. Greenhouse Gas Center Monday during the 28th annual United Nations Climate Conference (COP28).
    ...
    description:
      "NASA and IBM have teamed up to build an AI foundation model for weather and climate applications. They’re combining their respective knowledge and skills in the Earth science and AI fields, respectively, for the model, which they say should offer “significant…",
    publishedAt: "2023-11-30T05:01:41Z",
    source: { id: "engadget", name: "Engadget" },
    title:
      "NASA and IBM are building an AI for weather and climate applications",
    url: "https://www.engadget.com/nasa-and-ibm-are-building-an-ai-for-weather-and-climate-applications-050141545.html",
    urlToImage:
      "https://s.yimg.com/ny/api/res/1.2/Yg4SvghLS3A3zRaIcSFHAA--/YXBwaWQ9aGlnaGxhbmRlcjt3PTEyMDA7aD02NjM-/https://s.yimg.com/os/creatr-uploaded-images/2023-11/cbb0ac90-8ecc-11ee-aa7d-22f07550e148",
  },

  {
    author: "John Doe",
    content: `NASA will provide live launch and docking coverage of the Roscosmos Progress 86 cargo spacecraft carrying about three tons of food, fuel, and supplies for the Expedition 70 crew aboard the International Space Station.
    ...
    description: "Sample description for the second article",
